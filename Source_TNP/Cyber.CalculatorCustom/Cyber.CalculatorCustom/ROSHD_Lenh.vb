...
#Region "Load and System...."
    ...
    Private Sub V_AddHandler_Master()
        ...
        AddHandler CmdXuat.Click, AddressOf V_XuatExcel
...
#End Region
    ...
    Private Sub V_Load()
        ...
        ' TxtSo_Ro.Text = CyberVoucher.V_FormatSo_Ro(AppConn, Sysvar, "HDK", "S", "M", _Dt, TxtSo_Ro.Text, M_Ma_TTCP, M_Ma_Dvcs, M_User_Name, CyberSmlib)
        _DsLoai = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GET_TT", Nothing)
        _DtLoai = _DsLoai.Tables(0).Copy
        CyberFill.V_FillComBoxDefaul(Me.CbBMa_TT, _DtLoai, "Ma_TT", "Ten_TT", "Ngam_dinh")
    ...
    Private Sub V_LoadRo(ByVal _Load As String, ByVal _Load1 As String)
        ...
        Dim DsTmpRO As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetROSHD_LenhDetail1", _Load + "#" + _Load1 + "#" + Dt1.ToString("yyyyMMdd") + "#" + Dt2.ToString("yyyyMMdd") + "#" + M_Ma_Dvcs.Trim + "#" + M_User_Name)
    ...
    Private Sub V_Loaddatatabse(ByVal _Status As String, ByVal _So_Ro As String)
        ...
        Dim Dt1 As Date = Txtngay_ct1.Value
        Dim Dt2 As Date = Txtngay_ct2.Value
        Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetROSHD_LenhDetail", _Status + "#" + _So_Ro + "#" + _Pick + "#" + Dt1.ToString("yyyyMMdd") + "#" + Dt2.ToString("yyyyMMdd") + "#" + IIf(Chkis_Hd.Checked, "1", "0") + "#" + CbBMa_TT.SelectedValue + "#" + M_Ma_Dvcs.Trim + "#" + M_User_Name)
        ...
        Dt_Ro.Clear()
        If Chkis_Hd.Checked = True Then
            EditNgay_DK.ColumnReadOnly = True
        Else
            EditNgay_DK.ColumnReadOnly = False
        End If
        CyberSmodb.SQLTbToTb(DsTmp.Tables(1), Dt_Ro)

        If DsTmp.Tables(0).Columns.Contains("Ma_KH") Then TxtMa_KH.Text = DsTmp.Tables(0).Rows(0).Item("Ma_KH")

        If DsTmp.Tables(0).Columns.Contains("Ten_kh") Then TxtTen_KH.Text = DsTmp.Tables(0).Rows(0).Item("Ten_KH")
        If DsTmp.Tables(0).Columns.Contains("So_Ro_hang") Then TxtSo_RO_Hang.Text = DsTmp.Tables(0).Rows(0).Item("SO_RO_HANG")
    ...
    Private Sub DetailGRV_PopupMenuShowing(ByVal sender As System.Object, ByVal e As DevExpress.XtraGrid.Views.Grid.PopupMenuShowingEventArgs)
        ...
        PopupMenuChoGRV.ItemLinks.Add(New Cyber.SmLib.CyberMenuPopup(sender, 0, "Cập nhật thông tin hóa đơn", AddressOf V_CongViec, Nothing, Nothing, True, True), True).BeginGroup = True
    ...
    Private Function Tao_Px(ByVal _Loai As String, ByVal iRow As Integer) As String
        ...
        For i = j To nCount
            ...
            _StrSave = _StrSave + ";INSERT KTVKTVKTV SELECT '" & Dv_Ro.Item(i).Item("Ma_Kh").ToString.Trim & "',N'" & Dv_Ro.Item(i).Item("Ftag").ToString.Trim & "',N'" & Dv_Ro.Item(i).Item("SO_CT").ToString.Trim & "',N'" & Dv_Ro.Item(i).Item("So_Ro").ToString.Trim & "',N'" & Dv_Ro.Item(i).Item("Ngay_DK").ToString.Trim & "',N'" & Dv_Ro.Item(i).Item("So_Ro_hang").ToString.Trim & "'"
        Next
        If _StrSave = "" Then Return ""

        Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_ApprolSDH_Lenh", _Loai + "#" + _StrSave & "#" & TxtSo_Ro.Text & "#" & M_Ma_Dvcs & "#" & M_User_Name)
        ...
        If CyberSupport.V_MsgChk(DsTmp.Tables(0), Me.Sysvar, M_LAN) = True Then
            ...
            DsTmp.Dispose()
        End If
        MsgBox("Cập nhật thông tin thành công !", MsgBoxStyle.OkOnly, "Sửa hóa đơn")
    ...
    Private Sub V_XuatExcel(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim _Tu_Ngay As String = "TỪ NGÀY " & Txtngay_ct1.Text.ToString.Trim & " ĐẾN NGÀY  " & Txtngay_ct2.Text.ToString.Trim
        ...
        CyberExport.V_ExportToXls(AppConn, Me.DetailGRV, _Dv_Title, Dv_Ro1, Me.Para, Me.Sysvar, Me.Lan, M_Ma_Dvcs, M_User_Name, "C:\CYBER_Xuat_.xls")
    End Sub
    Private Sub V_danh_sach(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim Dt1 As Date = Txtngay_ct1.Value
        Dim Dt2 As Date = Txtngay_ct2.Value
        Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetROSHD_Lenh_Detail_Search", _status & "#" & Dt1.ToString("yyyyMMdd") & "#" & Dt2.ToString("yyyyMMdd") & "#" & TxtMa_KH.Text.ToString.Trim & "#" & TxtSo_RO_Hang.Text.ToString.Trim & "#" & IIf(Chkis_Hd.Checked, "1", "0") & "#" & CbBMa_TT.SelectedValue & "#" & M_Ma_Dvcs.Trim & "#" & M_User_Name)
