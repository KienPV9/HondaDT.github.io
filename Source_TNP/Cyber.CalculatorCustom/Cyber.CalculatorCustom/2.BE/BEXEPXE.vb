...
#End Region
    Private Sub BEXEPXE_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Save_OK = False
        V_Load()
        ...
        V_AddHander()
        V_DragDropGridview()
        Me.Text = "XẾP XE CHO CÁC HỢP ĐỒNG  - KÉO DI CHUỘT TỪ DỮ LIỆU SỐ KHUNG VÀO SỐ BẢNG DỮ LIỆU HỢP ĐỒNG"
...
#Region "Load and Fill"
    ...
    Private Sub V_Loaddatabases(ByVal status)
        ...
        Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_BeXepXe", status.ToString + "0" + "#" + "2" + "#" + Me.Thang1.ToString + "#" + Me.Nam1.ToString.Trim + "#" + Me.Thang2.ToString + "#" + Me.Nam2.ToString + "#" + Me.Stt_Rec + "#" + Me.Stt_Rec0 + "#" + _Ma_KX + "#" + _Ma_Mau + "#" +
    ...
    Private Sub V_Loaddatabases_SK(ByVal status As String)
        ...
        Dim DsTmp_1 As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_BeXepXe_SK", status.ToString + "#" + _Stt_Rec + "#" + _Stt_Rec0 + "#" + M_Ma_Dvcs + "#" + M_User_Name)
        If status = "1" Then
...
#Region "Event DragDrop"
    ...
    Private Sub Master_DragDrop(ByVal sender As Object, ByVal e As System.Windows.Forms.DragEventArgs)
        ...
        Dim _So_khung As String = _Dr_Master_1.Item("So_Khung").ToString.Trim

        If Not V_Xep_Xe(_Ma_HD, _Stt_Rec, _Stt_Rec0, _So_khung, IRow_Master, "0") Then
...
#Region "Event - Nut Lenh"
    ...
    End Sub
    Private Function V_Xep_Xe(ByVal _Ma_HD As String, ByVal _Stt_Rec As String, ByVal _Stt_Rec0 As String, ByVal _So_Khung As String, ByVal IRow_Master As Integer, ByVal _All As String) As Boolean
        If _Ma_HD.Trim = "" Or _Stt_Rec.Trim = "" Or _Stt_Rec0.Trim = "" Or _So_Khung.Trim = "" Then Exit Function
        Dim Dstmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_BeXepXe_SAVE", _Ma_HD & "#" & _Stt_Rec & "#" & _Stt_Rec0 & "#" & _So_Khung & "#" & M_Ma_Dvcs & "#" & M_User_Name)
    ...
    Private Sub V_Auto(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If MsgBox("Bạn thực hiện gán dữ liệu tự đồng không?", MsgBoxStyle.Exclamation + MsgBoxStyle.OkCancel, Me.Sysvar("M_CYBER_VER")) = MsgBoxResult.Cancel Then Exit Sub
        ...
        For iRow As Integer = 0 To Dv_Master.Count - 1
            ...
            If Not _So_khung.Trim = "" Then Continue For
            iRow_1 = iRow_1 + 1
            If iRow_1 >= Dv_Master_1.Count Then Exit For
            Dim _So_khung_Save As String = Dv_Master_1.Item(iRow_1).Item("So_Khung").ToString.Trim
            V_Xep_Xe(_Ma_HD, _Stt_Rec, _Stt_Rec0, _So_khung_Save, iRow, "1")
        Next
    ...
    Private Sub V_F8(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If MsgBox("Bạn thực hiện giải phóng xếp xe cho hợp đồng này không? ", MsgBoxStyle.Critical + MsgBoxStyle.YesNo, Me.Sysvar("M_CYBER_VER")) = MsgBoxResult.No Then Exit Sub
        Dim _Ma_HD As String = Dv_Master.Item(iRow).Item("Ma_HD").ToString.Trim
        Dim _Stt_Rec As String = Dv_Master.Item(iRow).Item("Stt_Rec").ToString.Trim
        Dim _Stt_Rec0 As String = Dv_Master.Item(iRow).Item("Stt_Rec0").ToString.Trim
        Dim _So_khung As String = Dv_Master.Item(iRow).Item("So_Khung").ToString.Trim
        V_F8(_Ma_HD, _Stt_Rec, _Stt_Rec0, _So_khung, iRow, "0")
        V_Refresh_Master_1(sender, e)
    End Sub
    Private Sub V_F8ALL(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If MsgBox("Bạn thực hiện giải phóng toàn bộ xếp xe không?", MsgBoxStyle.Critical + MsgBoxStyle.YesNo, Me.Sysvar("M_CYBER_VER")) = MsgBoxResult.No Then Exit Sub
        For iRow As Integer = 0 To Dv_Master.Count - 1
            Dim _Ma_HD As String = Dv_Master.Item(iRow).Item("Ma_HD").ToString.Trim
            Dim _Stt_Rec As String = Dv_Master.Item(iRow).Item("Stt_Rec").ToString.Trim
            Dim _Stt_Rec0 As String = Dv_Master.Item(iRow).Item("Stt_Rec0").ToString.Trim
            Dim _So_khung As String = Dv_Master.Item(iRow).Item("So_Khung").ToString.Trim
            V_F8(_Ma_HD, _Stt_Rec, _Stt_Rec0, _So_khung, iRow, "1")
        Next
        V_Refresh_Master_1(sender, e)
    End Sub
    Private Function V_F8(ByVal _Ma_HD As String, ByVal _Stt_Rec As String, ByVal _Stt_Rec0 As String, ByVal _So_Khung As String, ByVal IRow_Master As Integer, ByVal _all As String) As Boolean
        Dim Dstmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_BeXepXe_DELETE", _Ma_HD & "#" & _Stt_Rec & "#" & _Stt_Rec0 & "#" & _So_Khung & "#" & M_Ma_Dvcs & "#" & M_User_Name)
        If _all = "0" Then
