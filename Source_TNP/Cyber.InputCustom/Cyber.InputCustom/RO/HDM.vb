...
#Region "Load And Set And Default"
    ...
    Private Sub L_HDMGetThongTinHDX()
        ...
        If Dstmp.Tables(1).Columns.Contains("ma_kh") Then TxtMa_Kh.Text = Dstmp.Tables(1).Rows(0).Item("ma_kh").ToString.Trim
        If Dstmp.Tables(1).Columns.Contains("Ten_kx1") Then TxtTen_kx1.Text = Dstmp.Tables(1).Rows(0).Item("Ten_kx1").ToString.Trim
...
#Region "Valid --- Ma_Kx"
    ...
    Private Sub L_Ma_KX(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        ...
        If Not DrReturn Is Nothing Then
            ...
            TxtTen_kx1.Text = DrReturn.Item("Ten_KX")
        Else
            TxtMa_Kx.Text = ""
            TxtTen_Kx.Text = ""
            TxtTen_kx1.Text = ""
...
#Region "Valid --- Ma_Xe/So_khung"
    ...
    Private Sub V_Fill_TT(ByVal Dr As DataRow, ByVal Is_Xe As String)
        ...
        If V_IsFieldExist("ma_kh", Dr) Then TxtMa_Kh.Text = Dr.Item("ma_kh").ToString.Trim
        ...
        If V_IsFieldExist("Ma_Kx", Dr) Then
            ...
            TxtTen_kx1.Text = CyberSmodb.SQLGetvalue(AppConn, "Ten_Kx", "DmKx", "Ma_Kx = N'" + TxtMa_Kx.Text.Trim + "'", CyberSmlib)
...
#Region "Khach hang"
    ...
    Private Sub L_Ma_KH(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        ...
        If Not DrReturn Is Nothing Then
            ...
            txtTen_Lx.Text = IIf(txtTen_Lx.Text.Trim = "", DrReturn.Item("Ong_ba").ToString.Trim, TxtTen_kh.Text)
