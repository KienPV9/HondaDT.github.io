...
#Region "Valid - Detail - Core"
    Private Sub UpdateList()
        ...
        For iRow As Integer = 0 To Dv_DetailTmp.Count - 1
            nT_TT = nT_TT + Dv_DetailTmp.Item(iRow).Item("TT") - Dv_DetailTmp.Item(iRow).Item("T_N")
            nT_Da_TT = nT_Da_TT + Dv_DetailTmp.Item(iRow).Item("Da_TT_C")
            'nT_CL_TT = nT_CL_TT + Dv_DetailTmp.Item(iRow).Item("CL_TT")
        Next
        nT_CL_TT = nT_TT - nT_Da_TT
