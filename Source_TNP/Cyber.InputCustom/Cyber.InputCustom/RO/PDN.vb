...
#End Region
#Region "Columns Edit"
    Dim EditMa_lo, EditMa_kh_I As New Cyber.Fill.CyberColumnGridView 'Cyber.SmLists.EditLookUp
    ...
    Dim EditSo_Luong, EditGia_NT, EditGia, EditTien_NT, EditTien, EditDien_Giaii, EditSo_So, EditSo_Po, EditSo_Ro, EditSo_BG, EditSo_VT As New Cyber.Fill.CyberColumnGridView 'DevExpress.XtraEditors.Repository.RepositoryItemTextEdit
    Dim EditTen_Vt, EditDvt, EditTen_kho_i, EditDVT2 As New Cyber.Fill.CyberColumnGridView
    Dim EditDvt1, EditHe_So1, EditSo_Luong1, EditGIA_NHAP_QD, Editma_cv, Editten_cv3, Editma_ctcv As New Cyber.Fill.CyberColumnGridView
    Dim EditTON13, EditThue_suat, EditTien_thue As New Cyber.Fill.CyberColumnGridView
#End Region
#Region "Khai bao bien Private"
    ...
    Dim _Para_So_So As String = ""
#End Region
    Private Sub PDN_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_Load()
...
#Region "Load And Set And Default"
    Private Sub V_LoadNew(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If _Para_So_Ro.Trim = "" And _Para_So_BG.Trim = "" And _Para_So_So.Trim = "" Then Exit Sub
        V_New(sender, e)
        If Not M_Mode = "M" Then Exit Sub
        TxtLenh_RO.Text = _Para_So_Ro
        TxtLenh_BG.Text = _Para_So_BG
        TxtLenh_SO.Text = _Para_So_So
        If Not _Para_So_Ro.ToString.Trim = "" Then
            V_GetDetail("1", TxtLenh_RO.Text)
            Exit Sub
        End If
        If Not _Para_So_BG.ToString.Trim = "" Then
            V_GetDetail("2", TxtLenh_RO.Text)
            Exit Sub
        End If
        If Not _Para_So_So.ToString.Trim = "" Then
            V_GetDetail("3", TxtLenh_RO.Text)
            Exit Sub
        End If
        'V_Ma_Xe(sender, e)
    End Sub
    ...
    Private Sub V_Getdefault()
        ...
        _Para_So_Ro = ""
        Try
            _Para_So_Ro = M_Para(M_VT_PARA + 3).Trim
        ...
        _Para_So_So = ""
        Try
            _Para_So_So = M_Para(M_VT_PARA + 5).Trim
        Catch ex As Exception
        End Try
        '---------------------------------------------------------------------------------------------'
    ...
    Private Sub V_GetColumn()
        ...
        EditDVT2.GetColumn(DetailGRV, "DVT2")
        ...
        EditSo_BG.GetColumn(DetailGRV, "SO_BG")
        ...
        EditHe_So1.GetColumn(DetailGRV, "He_So1")
        EditSo_Luong1.GetColumn(DetailGRV, "So_Luong1")
        EditGIA_NHAP_QD.GetColumn(DetailGRV, "GIA_NHAP_QD")

        EditTON13.GetColumn(DetailGRV, "TON13")
...
#Region "V_AddHandler"
    ...
    Private Sub V_AddHandler_Master()
        ...
        AddHandler TxtMa_CVDV.CyberValiting, AddressOf V_Ma_CVDV
        AddHandler TxtMa_CVDV.CyberLeave, AddressOf L_Ma_CVDV
        ...
        AddHandler TxtLenh_BG.Leave, AddressOf L_Lenh_BG
        AddHandler TxtLenh_Vt.Leave, AddressOf L_Lenh_VT

    End Sub
    Private Sub V_AddHandler_Detail()
        If Not EditSo_Luong1.Column Is Nothing Then AddHandler EditSo_Luong1.EditColumn.Leave, AddressOf L_Tinh_Toan
        If Not EditSo_Luong.Column Is Nothing Then AddHandler EditSo_Luong.EditColumn.Leave, AddressOf L_Tinh_Toan
        If Not EditGIA_NHAP_QD.Column Is Nothing Then AddHandler EditGIA_NHAP_QD.EditColumn.Leave, AddressOf L_Tinh_Toan
        If Not EditThue_suat.Column Is Nothing Then AddHandler EditThue_suat.EditColumn.Leave, AddressOf L_Tinh_Toan
        If Not EditTien_thue.Column Is Nothing Then AddHandler EditTien_thue.EditColumn.Leave, AddressOf L_Tinh_Toan
        ...
        If Not EditSo_BG.Column Is Nothing Then AddHandler EditSo_BG.EditColumn.Leave, AddressOf L_So_BG
    ...
    Private Sub VisibleColumnMa_GD()
        If CbbMa_GD.SelectedValue.ToString.Trim = "7" Then
            EditDvt1.Visible = True
            EditHe_So1.Visible = True
            EditSo_Luong1.Visible = True
            EditGIA_NHAP_QD.Visible = True
        Else
            EditDvt1.Visible = False
            EditHe_So1.Visible = False
            EditSo_Luong1.Visible = False
            EditGIA_NHAP_QD.Visible = False
        End If
        If CbbMa_GD.SelectedValue.ToString.Trim = "5" Then
            EditMa_VT.Visible = False
            EditTen_Vt.Visible = False
            EditMa_Kho_I.Visible = False
            EditDvt.Visible = False
            EditDVT2.Visible = True
            EditTON13.Visible = False
            Editma_ctcv.Visible = True
            Editma_cv.Visible = True
            Editten_cv3.Visible = True
            EditTien_thue.Visible = True
            EditThue_suat.Visible = True
            TxtNgay_Ct0.Visible = True
            TxtSo_Ct0.Visible = True
            txtSo_Seri0.Visible = True
            LabSo_Ct0.Visible = True
            LabNgay_Ct0.Visible = True
            LabSo_Seri0.Visible = True
        Else
            EditMa_VT.Visible = True
            EditTen_Vt.Visible = True
            EditMa_Kho_I.Visible = True
            EditDvt.Visible = True
            EditDVT2.Visible = False
            EditTON13.Visible = True
            Editma_ctcv.Visible = False
            Editma_cv.Visible = False
            Editten_cv3.Visible = False
            EditTien_thue.Visible = False
            EditThue_suat.Visible = False
            TxtNgay_Ct0.Visible = False
            TxtSo_Ct0.Visible = False
            txtSo_Seri0.Visible = False
            LabSo_Ct0.Visible = False
            LabNgay_Ct0.Visible = False
            LabSo_Seri0.Visible = False
        End If
    End Sub
...
#Region "Valid --- Ma_HS_H"
    ...
    Private Sub L_Ma_HS_H(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        ...
        End If
    End Sub
    Private Sub V_Ma_CVDV(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        TxtMa_CVDV.V_LookUp(M_LAN, M_Para, osysvar, AppConn, DsLookup, "Ma_hs", "DmCVDV", "1=1", "1=1")
    End Sub
    Private Sub L_Ma_CVDV(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If TxtMa_CVDV.Text = "" Then
            TxtTen_CVDV.Text = ""
            Exit Sub
        End If
        DrReturn = TxtMa_CVDV.GetRowsSelectData(True)
        If Not DrReturn Is Nothing Then
            TxtMa_CVDV.Text = DrReturn.Item("Ma_HS")
            TxtTen_CVDV.Text = DrReturn.Item("Ten_HS")
        Else
            TxtMa_CVDV.Text = ""
            TxtTen_CVDV.Text = ""
        End If
...
#Region "Lenh/SO/Po/Ro/Vt"
    Private Sub L_Lenh_So(ByVal sender As System.Object, ByVal e As System.EventArgs)
        M_Mode = M_Mode.Trim
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If TxtLenh_SO.Text.Trim = "" Then Exit Sub
        Dim _Dt As Date = TxtNgay_Ct.Value
    ...
    Private Sub L_Lenh_Ro(ByVal sender As System.Object, ByVal e As System.EventArgs)
        M_Mode = M_Mode.Trim
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If TxtLenh_RO.Text.Trim = "" Then Exit Sub
        Dim _Dt As Date = TxtNgay_Ct.Value
        ...
        V_GetDetail("1", TxtLenh_RO.Text)
    End Sub
    Private Sub L_Lenh_Bg(ByVal sender As System.Object, ByVal e As System.EventArgs)
        M_Mode = M_Mode.Trim
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If TxtLenh_BG.Text.Trim = "" Then Exit Sub
        Dim _Dt As Date = TxtNgay_Ct.Value
        TxtLenh_BG.Text = CyberVoucher.V_GetSo_BG(M_Ma_CT, CbbMa_GD.SelectedValue, M_Mode, _Dt, TxtLenh_BG.Text, TxtMa_Dvcs.Text)
        V_GetDetail("2", TxtLenh_BG.Text)
    End Sub
    Private Sub L_Lenh_VT(ByVal sender As System.Object, ByVal e As System.EventArgs)
        M_Mode = M_Mode.Trim
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If TxtLenh_Vt.Text.Trim = "" Then Exit Sub
    ...
    End Sub
    Private Sub V_GetDetail(ByVal _Loai As String, ByVal _So As String)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If _So.Trim = "" Then Exit Sub
        Dim _Count As Integer = 0
        Dim Ma_GD_PDN As String = CbbMa_GD.SelectedValue.ToString.Trim
        For i As Integer = 0 To Dt_DetailTmp.Rows.Count - 1
            If Not Dt_DetailTmp.Rows(i).Item("Ma_Vt").ToString.Trim = "" Then _Count = _Count + 1
            If _Count > 0 Then Exit For
        Next
        If _Count > 0 Then Exit Sub
        Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_RoGetPDN", _Loai & "#" & _So & "#" & Ma_GD_PDN & "#" & M_Stt_Rec & "#" & M_Ma_Dvcs & "#" & M_User_Name)
...
#Region "Valid - Detail - Core"
    Private Sub UpdateList()
        ...
        For iRow As Integer = 0 To Dv_DetailTmp.Count - 1
            ...
            nT_Thue_NT = nT_Thue_NT + CyberSupport.V_Round(Dv_DetailTmp.Item(iRow).Item("Tien_Thue"), M_R_TIEN_NT)
        Next
    ...
    Private Sub V_Tinh_Toan(ByVal iRow As Integer)
        ...
        Dim _tien_sua_tay = Dv_DetailTmp.Item(iRow).Item("Tien_Thue")
        '--------------------------------------------------------------------------------
        If _Ma_GD = "7" Then
            If Dv_DetailTmp.Item(iRow).Item("So_Luong1") <> 0 Or Dv_DetailTmp.Item(iRow).Item("He_So1") <> 0 Then
                Dv_DetailTmp.Item(iRow).Item("So_Luong") = Dv_DetailTmp.Item(iRow).Item("So_Luong1") * Dv_DetailTmp.Item(iRow).Item("He_So1")
                Dv_DetailTmp.Item(iRow).Item("Tien_NT") = CyberSupport.V_Round(Dv_DetailTmp.Item(iRow).Item("So_Luong1") * Dv_DetailTmp.Item(iRow).Item("Gia_Nhap_QD"), M_R_TIEN_NT)

            End If
            If Dv_DetailTmp.Item(iRow).Item("So_Luong1") * Dv_DetailTmp.Item(iRow).Item("Gia_Nhap_QD") <> 0 Then
            ...
            End If
            If Dv_DetailTmp.Item(iRow).Item("So_Luong") * Dv_DetailTmp.Item(iRow).Item("Gia_NT") <> 0 And Dv_DetailTmp.Item(iRow).Item("So_Luong1") = 0 Then
                Dv_DetailTmp.Item(iRow).BeginEdit()
        ...
        If CbbMa_GD.SelectedValue = "5" Then

            Dv_DetailTmp.Item(iRow).BeginEdit()
            If Dv_DetailTmp.Item(iRow).Item("Tien_nt") <> 0 Then
                If Dv_DetailTmp.Item(iRow).Item("Tien_thue") = 0 Then
                    Dv_DetailTmp.Item(iRow).Item("Tien_thue") = CyberSupport.V_Round(Dv_DetailTmp.Item(iRow).Item("Thue_suat") * Dv_DetailTmp.Item(iRow).Item("Tien_nt") / 100, M_R_TIEN)
                End If
                If (_tien_sua_tay - (Dv_DetailTmp.Item(iRow).Item("Thue_suat") * Dv_DetailTmp.Item(iRow).Item("Tien_nt") / 100) <= 100) And (_tien_sua_tay - (Dv_DetailTmp.Item(iRow).Item("Thue_suat") * Dv_DetailTmp.Item(iRow).Item("Tien_nt") / 100) >= -100) Then
                    Exit Sub
                End If
                Dv_DetailTmp.Item(iRow).Item("Tien_thue") = CyberSupport.V_Round(Dv_DetailTmp.Item(iRow).Item("Thue_suat") * Dv_DetailTmp.Item(iRow).Item("Tien_nt") / 100, M_R_TIEN)
...
#Region "Vat tu kho/Vitri - "
    ...
    Private Sub L_Ma_Vt(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim _Dvt1 As String = DrReturn.Item("Dvt1")
        Dim _He_So1 As Double = DrReturn.Item("HS_QD")

        If _Dvt1 = "" Then _Dvt1 = DrReturn.Item("Dvt")
        If _He_So1 = 0 Then _He_So1 = 1
        ...
        Dv_DetailTmp.Item(iRow).Item("Dvt1") = _Dvt1
        Dv_DetailTmp.Item(iRow).Item("He_So1") = _He_So1
    ...
    Private Sub Tinh_Gia2(ByVal iRow As Integer)
        ...
        dsGia2 = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetPDNGia2", _Ngay_Ct.ToString("yyyyMMdd") & "#" & M_Ma_CT.Trim & "#" & M_Stt_Rec & "#" & M_Mode & "#" &
                                                    _Ma_GD & "#" & _Ma_Post & "#" & _Ma_vt.Trim & "#" & _Ma_Kho.Trim + "#" & _Ma_TT & "#" &
                                                    "0" & "#" & TxtMa_Dvcs.Text.Trim + "#" + M_User_Name.Trim)
        _Gia_NT = dsGia2.Tables(0).Rows(0).Item("Gia_NT")

        '-----------------------------------------------------------------------------------------------------------
        Dv_DetailTmp.Item(iRow).BeginEdit()
        Dv_DetailTmp.Item(iRow).Item("Gia_NT") = _Gia_NT
        Dv_DetailTmp.Item(iRow).Item("Gia_Nhap_QD") = dsGia2.Tables(0).Rows(0).Item("Gia_Nhap_QD")
...
#Region "So_So/So_PO/So_RO/So_VT"
    ...
    Private Sub L_So_BG(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If iRow < 0 Then Exit Sub
        Dim _Ngay_Ct As Date = TxtNgay_Ct.Value
        CyberVoucher.V_GetSo_BG(Dv_DetailTmp, iRow, M_Ma_CT, CbbMa_GD.SelectedValue, M_Mode, _Ngay_Ct, TxtMa_Dvcs.Text)
    End Sub
...
#Region "Button"
    Private Sub V_Save(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If Not CyberSmodb.V_SysCheckSaveVoucher(AppConn, osysvar, {Dt_DetailTmp, CyberSmodb.V_ConvertDrToTb(drMaster), Dt_DetailTmp}, {M_Ct, M_Ph, "CTGT30"}, M_Mode, CbbMa_Post.SelectedValue.ToString.Trim, CbbMa_GD.SelectedValue, M_Ma_CT, M_Stt_Rec, M_LAN, TxtMa_Dvcs.Text, M_User_Name, CyberSmlib, CyberSupport, DsSave) Then
    ...
    Private Function ChkVsave() As Boolean
        ...
        For iRow = nCount - 1 To 0 Step -1
            If Dt_DetailTmp.Rows(iRow).Item("Tien_nt").ToString.Trim = "" Then
        ...
        For iRow = 0 To Dt_DetailTmp.Rows.Count - 1
            ...
            If Dt_DetailTmp.Columns.Contains("So_RO") Then If TxtLenh_RO.Text.Trim <> "" Then Dt_DetailTmp.Rows(iRow).Item("So_RO") = TxtLenh_RO.Text.Trim
            If Dt_DetailTmp.Columns.Contains("So_BG") Then If TxtLenh_BG.Text.Trim <> "" Then Dt_DetailTmp.Rows(iRow).Item("So_BG") = TxtLenh_BG.Text.Trim
            If Dt_DetailTmp.Columns.Contains("So_So") Then If TxtLenh_SO.Text.Trim <> "" Then Dt_DetailTmp.Rows(iRow).Item("So_So") = TxtLenh_SO.Text.Trim
