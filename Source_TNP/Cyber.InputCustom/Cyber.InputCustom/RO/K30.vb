...
#Region "Columns Edit"
    ...
    Dim Editma_Db_I, EditMa_Xe_I, EditMa_KX_I, EditMa_LapKH_I, EditMa_Tuyen_I, EditMa_Ts, EditMa_Cc As New Cyber.Fill.CyberColumnGridView 'Cyber.SmLists.EditLookUp
...
#Region "Valid - Detail - Add On"
    Private Sub V_Ma_hs_i(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs)
        Dim iRow As Integer = -1
        CyberSupport.V_Lookup("Ma_hs", "DmCVDV", "1=1", "1=1", M_Mode, M_Ma_CT, M_LAN, M_Para, osysvar, AppConn, DsLookup, sender)
    End Sub
