...
#End Region
#Region "Columns Edit"
    Dim EditMa_BP_I, EditMa_HS_I, editma_chucvu, editma_chucdanh, editis_nghi, EditTien_HH, editTham_nien, edithe_so_TT, editTien_thuong, editTy_le, editKPIs, EditHe_so_thuong, editDiem_thuong As New Cyber.Fill.CyberColumnGridView
#End Region
...
#Region "Valid - Detail - Core"
    Private Sub UpdateList()
        ...
        'Next
        Dim n_tONG_HH As Decimal = 0

        For iRow As Integer = 0 To Dv_DetailTmp.Count - 1
            n_tONG_HH = n_tONG_HH + Dv_DetailTmp.Item(iRow).Item("Tien_HH")

        Next

        TxtT_HH.Double = n_tONG_HH
...
#Region "Button"
    ...
    Private Function ChkVsave() As Boolean
        ...
        For iRow = nCount - 1 To 0 Step -1
            If Dt_DetailTmp.Rows(iRow).Item("Ten_hs_i").ToString.Trim = "" Then
