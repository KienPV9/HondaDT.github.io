...
#Region "Columns Edit"
    ...
    Dim Edittien_maybay, Edittien_khachsan, Edittien_dilai, Edittien_an, Edittien_khac, Edittien_daotao As New Cyber.Fill.CyberColumnGridView
    Dim EditSo_Thang_Cam_Ket, EditNgay_HH_Cam_Ket, EditTen_Hs_I, EditChuc_Vu, EditTien, EditTien_ThuHoi As New Cyber.Fill.CyberColumnGridView
    Dim EditSo_Ngay, EditDVT, EditDon_gia, EditThanh_Tien, EditNoi_Dung, EditSo_Nguoi As New Cyber.Fill.CyberColumnGridView
#End Region
...
#Region "Load And Set And Default"
    Private Sub V_Load()
        ...
        TxtT_Tien.InputMask = IIf(DrDmct.Item("M_IP_MK_SL").ToString.Trim <> "", DrDmct.Item("M_IP_MK_SL").ToString.Trim, TxtT_Tien.InputMask)
    End Sub
    Private Sub V_Getdefault()
        ...
        CyberFill.V_FillComBoxValue(Me.CbbMa_GD, DtMaGD, "Ma_GD", If(M_LAN = "V", "Ten_GD", "Ten_GD2"), "1")
    ...
    Private Sub V_GetColumn()
        '--Cong
        Edittien_maybay.GetColumn(DetailGRV, "Tien_MayBay")
        Edittien_dilai.GetColumn(DetailGRV, "Tien_DiLai")
        Edittien_khachsan.GetColumn(DetailGRV, "Tien_KhachSan")
        Edittien_an.GetColumn(DetailGRV, "Tien_An")
        Edittien_khac.GetColumn(DetailGRV, "Tien_Khac")
        Edittien_daotao.GetColumn(DetailGRV, "Tien_DaoTao")
        '
        EditSo_Thang_Cam_Ket.GetColumn(DetailGRV, "So_Thang_Cam_Ket")
        EditNgay_HH_Cam_Ket.GetColumn(DetailGRV, "Ngay_HH_Cam_Ket")
        '
        EditTen_Hs_I.GetColumn(DetailGRV, "Ten_HS_I")
        EditChuc_Vu.GetColumn(DetailGRV, "Ma_ChucVu")
        EditTien.GetColumn(DetailGRV, "Tien")
        EditTien_ThuHoi.GetColumn(DetailGRV, "Tien_ThuHoi")
        EditSo_Ngay.GetColumn(DetailGRV, "So_NGay")
        EditDVT.GetColumn(DetailGRV, "DVT")
        EditDon_gia.GetColumn(DetailGRV, "Don_Gia")
        EditThanh_Tien.GetColumn(DetailGRV, "Thanh_Tien")
        EditNoi_Dung.GetColumn(DetailGRV, "Noi_Dung")
        EditSo_Nguoi.GetColumn(DetailGRV, "So_Nguoi")
        '
    ...
    Private Sub V_SetFocus(ByVal _Loai As String)
        ...
        Select Case _Loai
            Case "M"
                If DrDmct.Item("M_Ngay_CT").ToString.Trim <> "1" Then TxtNgay_Ct.Focus() Else TxtMa_BP_H.Focus()
            Case "S"
...
#Region "V_AddHandler"
    ...
    Private Sub V_AddHandler_System()
        AddHandler CmdPrintAll.Click, AddressOf V_In_DT
        ...
        AddHandler cmdXac_nhan.Click, AddressOf V_Xac_nhan
    End Sub
    ...
    Private Sub V_AddHandler_Detail()
        If Not Edittien_maybay.Column Is Nothing Then AddHandler Edittien_maybay.EditColumn.Leave, AddressOf L_Tinh_Toan
        If Not Edittien_khachsan.Column Is Nothing Then AddHandler Edittien_khachsan.EditColumn.Leave, AddressOf L_Tinh_Toan
        If Not Edittien_dilai.Column Is Nothing Then AddHandler Edittien_dilai.EditColumn.Leave, AddressOf L_Tinh_Toan
        '
        If Not Edittien_an.Column Is Nothing Then AddHandler Edittien_an.EditColumn.Leave, AddressOf L_Tinh_Toan
        If Not Edittien_khac.Column Is Nothing Then AddHandler Edittien_khac.EditColumn.Leave, AddressOf L_Tinh_Toan
        If Not Edittien_daotao.Column Is Nothing Then AddHandler Edittien_daotao.EditColumn.Leave, AddressOf L_Tinh_Toan
        '
        If Not EditSo_Thang_Cam_Ket.Column Is Nothing Then AddHandler EditSo_Thang_Cam_Ket.EditColumn.Leave, AddressOf V_Thang_Cam_Ket
        '
        If Not EditSo_Ngay.Column Is Nothing Then AddHandler EditSo_Ngay.EditColumn.Leave, AddressOf L_Tinh_Toan
        If Not EditSo_Nguoi.Column Is Nothing Then AddHandler EditSo_Nguoi.EditColumn.Leave, AddressOf L_Tinh_Toan
        If Not EditDon_gia.Column Is Nothing Then AddHandler EditDon_gia.EditColumn.Leave, AddressOf L_Tinh_Toan
    ...
    Private Sub VisibleColumnMa_GD()
        If CbbMa_GD.SelectedValue = "2" Then
            EditMa_HS_I.Visible = False
            Edittien_maybay.Visible = False
            Edittien_khachsan.Visible = False
            Edittien_an.Visible = False
            Edittien_khac.Visible = False
            Edittien_daotao.Visible = False
            Edittien_dilai.Visible = False
            EditSo_Thang_Cam_Ket.Visible = False
            EditNgay_HH_Cam_Ket.Visible = False
            Edittien_maybay.Visible = False
            EditTen_Hs_I.Visible = False
            EditChuc_Vu.Visible = False
            EditTien.Visible = False
            EditTien_ThuHoi.Visible = False
            EditNoi_Dung.Visible = True
            EditSo_Ngay.Visible = True
            EditDVT.Visible = True
            EditDon_gia.Visible = True
            EditThanh_Tien.Visible = True
            EditSo_Nguoi.Visible = True
        End If
        If CbbMa_GD.SelectedValue.ToString.Trim = "1" Or CbbMa_GD.SelectedValue.ToString.Trim = "3" Then
            EditMa_HS_I.Visible = True
            Edittien_maybay.Visible = True
            Edittien_khachsan.Visible = True
            Edittien_an.Visible = True
            Edittien_khac.Visible = True
            Edittien_daotao.Visible = True
            Edittien_dilai.Visible = True
            EditSo_Thang_Cam_Ket.Visible = True
            EditNgay_HH_Cam_Ket.Visible = True
            Edittien_maybay.Visible = True
            EditTen_Hs_I.Visible = True
            EditChuc_Vu.Visible = True
            EditTien.Visible = True
            EditTien_ThuHoi.Visible = True
            EditNoi_Dung.Visible = False
            EditSo_Ngay.Visible = False
            EditDVT.Visible = False
            EditDon_gia.Visible = False
            EditThanh_Tien.Visible = False
            EditSo_Nguoi.Visible = False
        End If
...
#Region "Valid --- Ma_BP_H"
    ...
    Private Sub V_Ma_CCDT(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        TxtMa_CCDT.V_LookUp(M_LAN, M_Para, osysvar, AppConn, DsLookup, "Ma_CCDT", "DmCCDT", "1=1", "1=1")
    End Sub
    Private Sub L_Ma_CCDT(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If TxtMa_CCDT.Text = "" Then
            TxtTen_CCDT.Text = ""
            Exit Sub
        End If
        DrReturn = TxtMa_CCDT.GetRowsSelectData(True)
        If Not DrReturn Is Nothing Then
        ...
        End If
    End Sub
    Private Sub V_Xac_nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If M_Mode = "X" And M_Stt_Rec <> "" Then
            Dim Ds As New DataSet
            Dim _ngay As Date = TxtNgay_Ct.Value
            Dim nS As Integer = 0
            If ChkXac_nhan.Checked = False Then
                If MsgBox("Bạn có muốn xác nhận hoàn thành đào tạo ?", MsgBoxStyle.YesNo + MsgBoxStyle.Critical, "CYBER9.0") = MsgBoxResult.Yes Then
                    ChkXac_nhan.Checked = True
                    Ds = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_XacNhanHTDT1", "1#DT1#" & M_Stt_Rec.Trim)
                End If
            End If

            If ChkXac_nhan.Checked = True Then
                MsgBox("Chứng chỉ đào tạo đã được xác nhận cho nhân viên !", MsgBoxStyle.OkOnly, "Cyber")
                Exit Sub
            End If
...
#Region "Valid - Detail - Core"
    Private Sub UpdateList()
        If CbbMa_GD.SelectedValue = "1" Or CbbMa_GD.SelectedValue = "3" Then
            Dim nT_Cong As Decimal = 0
            For iRow As Integer = 0 To Dv_DetailTmp.Count - 1
                nT_Cong = nT_Cong + Dv_DetailTmp.Item(iRow).Item("Tien")
            Next
            TxtT_Tien.Double = nT_Cong
        End If
        If CbbMa_GD.SelectedValue = "2" Then
            Dim nT_Cong As Decimal = 0
            For iRow As Integer = 0 To Dv_DetailTmp.Count - 1
                nT_Cong = nT_Cong + Dv_DetailTmp.Item(iRow).Item("Thanh_Tien")
            Next
            TxtT_Tien.Double = nT_Cong
        End If
        TxtT_Tien.Refresh()
    ...
    Private Sub V_Tinh_Toan(ByVal iRow As Integer)
        ...
        Dv_DetailTmp.Item(iRow).Item("Tien") = Dv_DetailTmp.Item(iRow).Item("Tien_DaoTao") + Dv_DetailTmp.Item(iRow).Item("Tien_MayBay") + Dv_DetailTmp.Item(iRow).Item("Tien_KhachSan") +
            Dv_DetailTmp.Item(iRow).Item("Tien_DiLai") + Dv_DetailTmp.Item(iRow).Item("Tien_An") + Dv_DetailTmp.Item(iRow).Item("Tien_Khac")
        Dv_DetailTmp.Item(iRow).Item("Thanh_tien") = CyberSupport.V_Round(Dv_DetailTmp.Item(iRow).Item("So_Nguoi") * Dv_DetailTmp.Item(iRow).Item("So_Ngay") * Dv_DetailTmp.Item(iRow).Item("Don_Gia"), 0)
    ...
    Private Sub L_Tinh_Toan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        V_Tinh_Toan(iRow)
    End Sub
    Private Sub V_Thang_Cam_Ket(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        Dim iRow As Integer = -1
        iRow = DetailGRV.GetFocusedDataSourceRowIndex
        If iRow < 0 Then Exit Sub
        ...
        CyberSupport.V_UpdateGRV(DetailGRV)
    End Sub
    Private Sub V_Tinh_HH(iRow As Integer)
        '
        Dim _so_thang As Integer = Dv_DetailTmp.Item(iRow).Item("So_Thang_Cam_Ket")
        Dim _ngay_hh As DateTime = DateAdd(DateInterval.Month, _so_thang, TxtNgay_KT.Value)

        Dv_DetailTmp.Item(iRow).BeginEdit()
        Dv_DetailTmp.Item(iRow).Item("Ngay_HH_Cam_Ket") = _ngay_hh
        Dv_DetailTmp.Item(iRow).EndEdit()
        '
    End Sub
...
#Region "Valid - Detail - Add On"
    ...
    Private Sub L_Ma_HS_i(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If DrReturn Is Nothing Then
            ...
            Dv_DetailTmp.Item(iRow).Item("Ma_ChucVu") = ""
            Dv_DetailTmp.Item(iRow).EndEdit()
            Exit Sub
        Else
            Dv_DetailTmp.Item(iRow).BeginEdit()
            ...
            Dv_DetailTmp.Item(iRow).Item("Ma_ChucVu") = DrReturn("Ma_ChucVu").ToString.Trim
            Dv_DetailTmp.Item(iRow).EndEdit()
        End If
        Dv_DetailTmp.Table.AcceptChanges()
...
#Region "Ngay ct, ngay lap chung tu,so chung tu"
    Private Sub V_Ngay_KT(ByVal sender As Object, ByVal e As System.EventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
...
#End Region
#Region "Button"
    Private Sub V_In_DT(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Private Sub V_Save(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        '----------------------------------------------------------------------------------------------------------------------
        If Not CyberSupport.ChkVoucherInput(Me, AppConn, osysvar, M_LAN, DrDmct, M_Mode, M_Ma_CT, _Ngay_Ct, CbbMa_GD.SelectedValue, M_Stt_Rec, CbbMa_Post.SelectedValue, M_Ma_Dvcs, M_User_Name, Dt_DetailTmp, "Ten_hs", "Ten_hs", CyberSmlib, CyberSupport, CyberSmodb, CyberLoading) Then Exit Sub
        '----------------------------------------------------------------------------------------------------------------------
