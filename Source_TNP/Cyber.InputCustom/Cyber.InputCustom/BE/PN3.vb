...
#End Region
#Region "Columns Edit"
    Dim EditMa_Kx, EditMa_Mau, EditMa_Vitri, EditMa_Kho_I, EditMa_Vv_I, EditMa_Phi_i, EditMa_HD_I, EditMa_SP_I, EditMa_ku_I, EditMa_TTLN_i, EditMa_TTCP_i, EditMa_BP_I, EditMa_Hs_I, EditMa_CD_I, EditMa_TD1_I, EditMa_TD2_I, EditMa_TD3_I, EditMa_TD4_I, EditMa_TD5_I As New Cyber.Fill.CyberColumnGridView
    Dim EditMa_Lo, EditTk_Vt, Editma_Db_I, EditMa_Xe_I, EditMa_Kx_I, EditMa_Tuyen_I, EditMa_Ts, EditMa_Cc As New Cyber.Fill.CyberColumnGridView
    Dim EditTen_Kx, EditTen_Mau, EditDvt, EditTen_Kho_i, EditTen_Tk_Vt, EditSo_Luong, EditGia_NT0, EditGia0, EditGia_NT, EditTien_Nt0, EditTien0, EditCP_NT, EditCP, EditGia, EditTien_Nt, EditTien, EditDien_Giaii, EditSo_So, EditSo_Po, EditSo_Ro, EditSo_VT As New Cyber.Fill.CyberColumnGridView
#End Region
...
#End Region
    Private Sub PN3_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_Load()
...
#Region "Lenh/SO/Po/Ro/Vt"
    ...
    Private Sub L_Lenh_Po(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        TxtLenh_PO.Text = CyberVoucher.V_FormatSo_POBE(AppConn, osysvar, M_Ma_CT, CmbMa_GD.SelectedValue, M_Mode, _Dt, TxtLenh_PO.Text, CmbMa_TTCP_H, M_Ma_Dvcs, M_User_Name, CyberSmlib)
    End Sub
...
#Region "Vat tu kho/Vitri - "
    ...
    Private Sub V_SetSD(ByVal iRow As Integer)
        ...
        Dim _Return As DataRow = CyberSupport.V_SetSD(StatusFooter1, AppConn, "XE", M_Mode, _Ma_Kx, _Ma_Kho, _Ma_Mau, _Ma_vitri, M_Stt_Rec, M_Ma_CT, M_Ma_Dvcs, M_User_Name, CyberSmlib)
        ...
        End If
    End Sub
    Private Sub V_SetPriceXePurChase(ByVal iRow As Integer)
        ...
        Dim _Ma_Kh As String = TxtMa_Kh.Text
        Dim _ngay_Ct As Date = TxtNgay_Ct.Value
        Dim DsgetPrice As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetPriceXePurchase", _Ma_Kx.Trim + "#" + _Ma_Mau.Trim + "#" + _Ma_Kh + "#" + _
...
#Region "Button"
    Private Sub V_Save(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If Not CyberSmodb.V_SysCheckSaveVoucher(AppConn, osysvar, {Dt_DetailTmp, CyberSmodb.V_ConvertDrToTb(drMaster), Dt_DetailVaTTmp}, {M_Ct, M_Ph, "CTGT30"}, M_Mode, CbbMa_Post.SelectedValue.ToString.Trim, CmbMa_GD.SelectedValue, M_Ma_CT, M_Stt_Rec, M_LAN, TxtMa_Dvcs.Text, M_User_Name, CyberSmlib, CyberSupport, DsSave) Then
    ...
    Private Sub V_Save_Luu(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        If Not CyberSupport.V_ChkExistNovoucher(AppConn, osysvar, M_LAN, DrDmct, M_Mode, M_Stt_Rec, M_Ma_CT, TxtSo_Ct.Text.Trim, _Ngay_Ct, _Ngay_LCt, M_Ma_Dvcs, M_User_Name, CyberSmlib) Then Exit Sub '---Kiem tra trung so chung tu
        '----------------------------------------------------------------------------------------------------------------------
        If Not ChkPN3PN4(M_Mode) Then Exit Sub
        '----------------------------------------------------------------------------------------------------------------------
    ...
    Private Function ChkVsave() As Boolean
        ...
        Next
        '---------------------------------------------------------------------------------
        Dim DtGroup As DataTable = CyberSmodb.dtSumGroup("So_Luong", "So_Khung", Dt_DetailTmp, "1=1")
        If DtGroup.Rows.Count < Dt_DetailTmp.Rows.Count Then
            MsgBox("Có số khung trùng nhau, bạn không nhập được", MsgBoxStyle.Critical + MsgBoxStyle.OkOnly, osysvar("M_CYBER_VER"))
            Return False
        End If
        '---------------------------------------------------------------------------------
        ...
        ChkVsave = True
    End Function
    Private Function ChkPN3PN4(ByVal _Mode) As Boolean
        ...
        Dim strSo_khung As String = ""
        Dim strSo_May As String = ""
        Dim strSo_Po As String = ""
        For i As Integer = 0 To nCount - 1
            ...
            strSo_khung = strSo_khung + IIf(i = 0, "", "!~!") + Dt_DetailTmp.Rows(i).Item("So_khung").ToString.Trim
            strSo_May = strSo_May + IIf(i = 0, "", "!~!") + Dt_DetailTmp.Rows(i).Item("So_May").ToString.Trim
            strSo_Po = strSo_May + IIf(i = 0, "", "!~!") + Dt_DetailTmp.Rows(i).Item("So_Po").ToString.Trim
        Next
        DsTmp = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_ChkPN3PN4", nCount.ToString.Trim & "#" & _Mode & "#" & _Dt.ToString("yyyyMMdd") & "#" & _So & "#" & strMa_Kx & "#" & strMa_Mau & "#" & strSo_khung & "#" & strSo_May & "#" & strSo_Po & "#" & Stt_Rec.Trim & "#" & M_Ma_Dvcs & "#" & M_User_Name)
    ...
    Private Sub V_Delete(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        For iRow As Integer = 0 To Dv_Master.Count - 1
            ...
            End If
        Next
        If Not ChkPN3PN4("D") Then Exit Sub
