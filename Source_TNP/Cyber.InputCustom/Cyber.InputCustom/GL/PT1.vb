...
#End Region
    Private Sub PT1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_Load()
...
#End Region
    Private Sub V_GetMa_VV()
        ...
        Dim _Ma_TD3 As String = If(Dt_DetailTmp.Columns.Contains("MA_TD3_I"), Dv_DetailTmp.Item(iRow).Item("MA_TD3_I").ToString.Trim, "")

        Dim DsGia_Ban As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetMa_VV", _Ma_HD & "#" & _Ma_TD3 & "#" & M_Stt_Rec & "#" &
               M_Ma_CT & "#" & M_Mode & "#" & M_Ma_Dvcs & "#" & M_User_Name)

        Dt_DetailTmp.Rows(iRow).BeginEdit()
        Dt_DetailTmp.Rows(iRow).Item("MA_VV_I") = DsGia_Ban.Tables(0).Rows(0).Item("Ma_VV")
