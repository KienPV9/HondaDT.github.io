...
#End Region
    Private Sub V_So_DN(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetDataPC1FromLDN", So_DN & "#" & M_Stt_Rec & "#" & M_Ma_CT & "#" & Dt1.ToString("yyyyMMdd") & "#" & M_Mode & "#" & M_Ma_Dvcs & "#" & M_User_Name & "#" & TxtMa_Dnchi.Text)
        ...
        '---
        If DsTmp.Tables(1).Columns.Contains("TK_H") Then TxtTk.Text = DsTmp.Tables(1).Rows(0).Item("TK_H").ToString.Trim
        If DsTmp.Tables(1).Columns.Contains("Ten_TK_H") Then Txtten_Tk.Text = DsTmp.Tables(1).Rows(0).Item("Ten_TK_H").ToString.Trim
    End Sub
#End Region
#End Region
#Region "Valid - Detail"
