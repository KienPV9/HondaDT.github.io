...
#End Region
    Private Sub PND_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_Load()
        V_GetColumn()
        V_AddHandler()
        V_Databing()
...
#Region "V_AddHandler"
    ...
    Private Sub V_AddHandler_Master()
        ...
        '----------------------------------------------------------------------------------------------------------
        AddHandler CmdChon_HD.Click, AddressOf V_Chon_HD
        AddHandler CmdChon_PT.Click, AddressOf V_Chon_PT
        AddHandler TxtT_CL_PB_PT.Leave, AddressOf L_T_CL_PB

        AddHandler ChkAuto_PB.CheckedChanged, AddressOf V_Auto_PB
        AddHandler ChkAuto_PB_Tien.CheckedChanged, AddressOf V_Auto_PB_Tien
        AddHandler ChkAuto_PB_CL.CheckedChanged, AddressOf V_Auto_PB_CL
    ...
    Private Sub V_AddHandler_Detail()
        ...
        If Not EditTien_NT.Column Is Nothing Then AddHandler EditTien_NT.EditColumn.Leave, AddressOf L_Tien_NT
...
#Region "Valid - Detail - Core"
    Private Sub UpdateList()
        ...
        Dim nT_Da_PB As Decimal = 0
        Dim nT_Cl_PB As Decimal = 0
        ...
        For iRow As Integer = 0 To Dv_DetailTmp.Count - 1
            ...
            nT_Tien_Hang = nT_Tien_Hang + Dv_DetailTmp.Item(iRow).Item("Tien_Hang")
            nT_Thue = nT_Thue + Dv_DetailTmp.Item(iRow).Item("Thue")
            nT_Tong_Cong = nT_Tong_Cong + Dv_DetailTmp.Item(iRow).Item("Tong_Cong")

            nT_Da_PB = nT_Da_PB + Dv_DetailTmp.Item(iRow).Item("Da_PB")
            nT_Cl_PB = nT_Cl_PB + Dv_DetailTmp.Item(iRow).Item("Cl_PB")
        ...
        TxtT_Da_PB.Double = nT_Da_PB
        TxtT_CL_PB.Double = nT_Cl_PB
    ...
    Private Sub V_Tinh_Toan(ByVal iRow As Integer)
        ...
        UpdateList()
    End Sub
    Private Sub L_Tien_NT(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If ChkAuto_PB.Checked Then Return
...
#Region "Button"
    ...
    End Sub
    Private Function V_GetSo_Ct() As Boolean
        If Not (M_Mode = "M" Or M_Mode = "S") Then Return False
        Dim _Ngay_Ct As Date = TxtNgay_Ct.Value
        Dim Dstmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_TBHGetSo_Ct", M_Mode.Trim + "#" + M_Ma_CT + "#" + _Ngay_Ct.ToString("yyyyMMdd") + "#" + M_Ma_Dvcs + "#" + M_User_Name)
        ...
        If Dstmp.Tables(0).Rows.Count = 0 Then
            ...
            Return False
        End If
        If Dstmp.Tables(0).Columns.Contains("So_Ct") Then txtSo_ct.Text = Dstmp.Tables(0).Rows(0).Item("So_Ct").ToString.Trim
        Dstmp.Dispose()
        Return True
    End Function
    Private Function ChkVsave() As Boolean
        ...
        For iRow = nCount - 1 To 0 Step -1
            If Dt_DetailTmp.Rows(iRow).Item("So_RO").ToString.Trim = "" Or Dt_DetailTmp.Rows(iRow).Item("Tien_Nt") = 0 Then
        ...
        For iRow = 0 To Dt_DetailTmp.Rows.Count - 1
            ...
            Dt_DetailTmp.Rows(iRow).Item("Tien") = Dt_DetailTmp.Rows(iRow).Item("Tien_NT")
            ...
            If Dt_DetailTmp.Columns.Contains("Stt_Rec_PT") Then Dt_DetailTmp.Rows(iRow).Item("Stt_Rec_PT") = TxtStt_Rec_PT.Text
            If Dt_DetailTmp.Columns.Contains("So_PT") Then Dt_DetailTmp.Rows(iRow).Item("So_PT") = TxtSo_PT.Text
            If Dt_DetailTmp.Columns.Contains("Ngay_PT") Then Dt_DetailTmp.Rows(iRow).Item("Ngay_PT") = TxtNgay_PT.Value
    ...
    Private Sub V_New(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        V_Databing()
        '----------------------------------------------------------------------
        ChkAuto_PB.Checked = True
        ChkAuto_PB_Tien.Checked = True
        ChkAuto_PB_CL.Checked = False
        V_VisibleAuto_PB()
        '----------------------------------------------------------------------
        TxtStt_Rec.Text = M_Stt_Rec
...
#Region "Sms - Import"
    ...
    Private Sub SetTxt()
        ...
        TxtT_Da_PB.ReadOnly = True
        TxtT_CL_PB.ReadOnly = True

        TxtTen_kh.ReadOnly = True

        TxtSo_PT.ReadOnly = True
        TxtNgay_PT.ReadOnly = True
        TxtStt_Rec_PT.ReadOnly = True
        TxtT_Tien_PT.ReadOnly = True
        TxtT_Da_PB_PT.ReadOnly = True

        TxtSo_PT.Enabled = False
        TxtNgay_PT.Enabled = False
        TxtStt_Rec_PT.Enabled = False
        TxtT_Tien_PT.Enabled = False
        TxtT_Da_PB_PT.Enabled = False
        txtSo_ct.ReadOnly = True

    End Sub
#End Region
#Region "Phan bo/Chon hoa don/Phieu thu"
    Private Sub V_VisibleAuto_PB()
        ChkAuto_PB_Tien.Visible = ChkAuto_PB.Checked
        ChkAuto_PB_CL.Visible = ChkAuto_PB.Checked



    End Sub
    Private Sub V_Auto_PB(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        V_Phan_BO()

        'If ChkAuto_PB.Checked Then EditTien.ColumnReadOnly = True Else EditTien.ColumnReadOnly = False
        'If ChkAuto_PB.Checked Then EditTien_NT.ColumnReadOnly = True Else EditTien_NT.ColumnReadOnly = False
        If ChkAuto_PB.Checked Then EditTien_NT.EditColumn.ReadOnly = True Else EditTien_NT.EditColumn.ReadOnly = False

        V_VisibleAuto_PB()
    End Sub
    Private Sub V_Auto_PB_Tien(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        ChkAuto_PB_CL.Checked = Not ChkAuto_PB_Tien.Checked
        V_Phan_BO()
    End Sub

    Private Sub V_Auto_PB_CL(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        ChkAuto_PB_Tien.Checked = Not ChkAuto_PB_CL.Checked
        V_Phan_BO()
    End Sub

    Private Sub L_T_CL_PB(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        Dim nT_Cl_PB As Decimal = TxtT_CL_PB_PT.Double
        V_Phan_BO()
    End Sub
    Private Sub V_Phan_BO()
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub
        If Not ChkAuto_PB.Checked Then Return

        If ChkAuto_PB_Tien.Checked Then
            CyberSupport.Phan_Bo(Dt_DetailTmp, "Tong_Cong", "Tien_NT", TxtT_CL_PB_PT.Double, M_R_TIEN_NT)
        Else
            CyberSupport.Phan_Bo(Dt_DetailTmp, "CL_PB", "Tien_NT", TxtT_CL_PB_PT.Double, M_R_TIEN_NT)
        End If
        UpdateList()
    End Sub
    Private Sub V_Chon_HD(ByVal sender As System.Object, ByVal e As System.EventArgs)

        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub

        Dim _Ma_KH As String = TxtMa_Kh.Text
        Dim frm As New FrmLocHDSTBH
        ...
        'hieulv sửa thêm, nếu tổng giá trị hóa đơn đã chọn nhỏ hơn phiếu thu:
        Dim _t_tien_HDS As Double = 0
        If Dt.Rows.Count > 0 Then
            If Dt.Columns.Contains("T_CL_PB_PT") Then _t_tien_HDS = Dt.Rows(0).Item("T_CL_PB_PT")
            If _t_tien_HDS > 0 And _t_tien_HDS < TxtT_CL_PB_PT.Double Then
                TxtT_CL_PB_PT.Double = _t_tien_HDS
            End If
        End If
        ...
        UpdateList()
    End Sub
    Private Sub V_Chon_PT(ByVal sender As System.Object, ByVal e As System.EventArgs)
        If Not (M_Mode = "M" Or M_Mode = "S") Then Exit Sub

        Dim _Ma_KH As String = TxtMa_Kh.Text
        Dim frm As New FrmLocPT1TBH
        ...
        TxtStt_Rec_PT.Text = ""
        TxtSo_PT.Text = ""
        TxtT_Tien_PT.Double = 0
        TxtNgay_PT.Value = Now.Date

        If Dt.Rows.Count = 0 Then Return

        If Dt.Columns.Contains("Stt_Rec_PT") Then TxtStt_Rec_PT.Text = Dt.Rows(0).Item("Stt_Rec_PT")
        If Dt.Columns.Contains("So_PT") Then TxtSo_PT.Text = Dt.Rows(0).Item("So_PT")
        If Dt.Columns.Contains("Ngay_PT") Then TxtNgay_PT.Value = Dt.Rows(0).Item("Ngay_PT")
        If Dt.Columns.Contains("T_Tien_PT") Then TxtT_Tien_PT.Double = Dt.Rows(0).Item("T_Tien_PT")
        If Dt.Columns.Contains("T_Da_PB_PT") Then TxtT_Da_PB_PT.Double = Dt.Rows(0).Item("T_Da_PB_PT")
        If Dt.Columns.Contains("T_CL_PB_PT") Then TxtT_CL_PB_PT.Double = Dt.Rows(0).Item("T_CL_PB_PT")

        If Dt.Columns.Contains("Ma_Kh_PT") Then TxtMa_Kh.Text = Dt.Rows(0).Item("Ma_Kh_PT").ToString.Trim
        If Dt.Columns.Contains("Ten_Kh_PT") Then TxtTen_kh.Text = Dt.Rows(0).Item("Ten_Kh_PT").ToString.Trim
        If Dt.Columns.Contains("Dia_Chi_PT") Then If Not Dt.Rows(0).Item("Dia_Chi_PT").ToString.Trim = "" Then TxtDia_Chi.Text = Dt.Rows(0).Item("Dia_Chi_PT").ToString.Trim
        If Dt.Columns.Contains("Ong_ba_PT") Then If Not Dt.Rows(0).Item("Ong_ba_PT").ToString.Trim = "" Then txtOng_ba.Text = Dt.Rows(0).Item("Ong_ba_PT").ToString.Trim
...
#Region "Tạo đề nghị thanh toán"
    ...
    Private Sub V_Tao_De_nghi(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim _So_ct As String = txtSo_ct.Text.Trim
        If _So_ct.Trim = "" Then Return
        Dim strAddParar As String = "1#LDN#10#" & _So_ct & "#" & "#"
