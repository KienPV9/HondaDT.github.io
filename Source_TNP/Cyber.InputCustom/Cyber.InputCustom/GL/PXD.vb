...
#Region "Columns Edit"
    ...
    Dim EditDvt1, EditHe_So1, EditSo_Luong1, EditTen_Vt, EditTen_Nx_I, EditTen_Tk_VT, EditTen_kho_i, EditDvt, EditSo_Luong, EditGia_NT, EditGia, EditTien_NT, EditTien, EditDien_Giaii, EditSo_So, EditSo_Po, EditSo_Ro, EditSo_VT As New Cyber.Fill.CyberColumnGridView 'DevExpress.XtraEditors.Repository.RepositoryItemTextEdit
#End Region
...
#End Region
    Private Sub PXD_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_Load()
...
#Region "V_AddHandler"
    ...
    Private Sub V_AddHandler_Master()
        ...
        'So_DN
        AddHandler TxtSo_DN_PNL.Leave, AddressOf V_So_DN
    End Sub
    ...
    Private Sub VisibleColumnMa_GD()
        If CbbMa_GD.SelectedValue = "4" Then
        ...
        If CbbMa_GD.SelectedValue = "5" Then
            EditMa_TD2_I.Visible = True
            EditMa_HD_I.Visible = True
            EditMa_TD3_I.Visible = True
            LblSo_DN.Visible = True
            TxtSo_DN_PNL.Visible = True
        Else
            EditMa_TD2_I.Visible = False
            EditMa_HD_I.Visible = False
            EditMa_TD3_I.Visible = False
            LblSo_DN.Visible = False
            TxtSo_DN_PNL.Visible = False
        End If
    End Sub
...
#Region "load DN"
    Private Sub V_So_DN(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Dim So_DN As String = TxtSo_DN_PNL.Text.Trim

        If Not (M_Mode = "M" Or M_Mode = "S") Or So_DN = "" Then Exit Sub

        Dim DsTmp As DataSet = CyberSmlib.SQLExcuteStoreProcedure(AppConn, "CP_GetDataPXDFromPNL", So_DN & "#" & M_Stt_Rec & "#" & M_Ma_CT & "#" & Dt1.ToString("yyyyMMdd") & "#" & M_Mode & "#" & M_Ma_Dvcs & "#" & M_User_Name)
        ...
        ' 
        'hieulv
        Dim _Dien_Giai As String = DsTmp.Tables(0).Rows(0).Item("Dien_Giai").ToString.Trim
        Dim _ten_hs As String = DsTmp.Tables(0).Rows(0).Item("Ten_Hs").ToString.Trim

        txtDien_giai.Text = _Dien_Giai
        If TxtTen_Hs.Text = "" Then TxtTen_Hs.Text = _ten_hs
...
#Region "Valid - Detail - Core"
    ...
    Private Sub V_Tinh_Toan(ByVal iRow As Integer)
        ...
        '--------------------------------------------------------------------------------
        If Dv_DetailTmp.Item(iRow).Item("So_Luong1") <> 0 Then
