...
#End Region
    ...
    Private Sub V_LoadThangNam()
        ...
        CyberFill.V_FillComBoxDefaul(Me.CmdThang, Thang, "Ma_Thang", "Ten_Thang", "")
...
#Region "Button"
    Private Sub V_Nhan(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim M_Thang As String = Me.CmdThang.SelectedValue.ToString.Trim

        Dim M_strParameterStore As String = M_Thang
