Public Class RO_DD01
    Dim DtThang1, DtThang2, DtNam, _DtLoai_Phieu As DataTable
    Dim DrReturn As DataRow
    Dim DsLookup As DataSet
    Dim CyberMe As New Cyber.ReportsCustom.Sys
    Private Sub SysMonthToMonth_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        V_AddMenuShorcut()
        V_Load()
        V_Addhander()
    End Sub
